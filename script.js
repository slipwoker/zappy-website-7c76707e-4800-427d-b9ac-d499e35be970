        ...
        function validateField(field) {
            ...
            if (!value) {
                const label = field.getAttribute('aria-label') || 
                              field.closest('label')?.textContent?.replace('*', '').trim() || 
                              field.name || 
                              'This field';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '7c76707e-4800-427d-b9ac-d499e35be970',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '7c76707e-4800-427d-b9ac-d499e35be970';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '7c76707e-4800-427d-b9ac-d499e35be970';
